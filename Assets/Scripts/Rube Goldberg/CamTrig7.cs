...
public class CamTrig7 : MonoBehaviour
{
    ...
    { 
        ...
        { 
            mainCam.transform.position = new Vector3(0.89f, -0.84f, mainCam.transform.position.z); //set the position of the camera to the current game objects position
