...
public class CamTrig5 : MonoBehaviour
{
    ...
    { 
        ...
        { 
            mainCam.transform.position = new Vector3(-2.77f, -4.84f, mainCam.transform.position.z); //set the position of the camera to the current game objects position
