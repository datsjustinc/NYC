...
public class CamTrig6 : MonoBehaviour
{
    ...
    { 
        ...
        { 
            mainCam.transform.position = new Vector3(0.89f, -3.59f, mainCam.transform.position.z); //set the position of the camera to the current game objects position
