...
public class CamTrig3 : MonoBehaviour
{
    ...
    { 
        ...
        { 
            mainCam.transform.position = new Vector3(0.91f, -4.81f, mainCam.transform.position.z); //set the position of the camera to the current game objects position
