...
public class BlockMovement2 : MonoBehaviour
{
    ...
    void Start() 
    {
        minimum = -0.2f; // set lowest position to object y value
        maximum = 1.48f; // set highest position to object y value plus the distance to move
    }
